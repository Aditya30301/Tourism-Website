            ...
            <Container maxWidth="l">
              ...
              >
                ...
                <h5 style={{ textAlign: "center", fontFamily: "revert" }}>
                  Welcome to Andman <h5 style={{ color: "#00e699" }}>Emrald</h5>{" "}
                  We are here to make your holidays in Andaman a Pleasent joyful
                  experience
                </h5>
                <div className="BoxContainer">
                  <div className="ContainerRight">
                    <h1 style={{ fontFamily: "monospace" }}>
                      <br />
                      <br />
                      Andaman <h2 style={{ color: "#00e699" }}> Emrald </h2>
                    </h1>
                  ...
                  <div className="ContainerLeft">
                    ...
                    >
                      We provide you with the best experince of Andaman with
                      precisely tailoured packages.
